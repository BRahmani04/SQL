/*
Write a query to display the employee id, employee name (first name and last name) for all employees
...
/*
4.Write a query to display all the information of the employees
whose salary is within the range of the smallest salary and 2500.
*/
...
/*
5.Write a SQL query to find the 
first name, last name, department, city, and state province for each employee.
*/
...
/*
8.Write a query to display the employee number, name (first name and last name), and salary for 
all employees who earn more than the average salary and who work in a department with any employee with a J in their name.
*/
...
/*
12.Write a query to display the employee number, name (first name and last name) and job title for all employees whose salary
...
/*
13.Write a query to display the employee number, name (first name and last name) and job
...
from employees e join departments d
on e.department_id = d.department_id
where salary > (select avg(salary) from employees where department_name = 'IT');
...
/*
20.Write a SQL query to find the employees and their managers. 
...
on e.manager_id = m.employee_id;
?? -- I dont understand the question for this one so if its not left then it will be right join.
...
as the employee with the last name Taylor. Return first name, last name and department ID.
*/
...
/*
Write a query to display the name (first name and last name), salary, department id for those employees
...
where salary > (select 0.5 * sum(salary) from employees where department_id = e.department_id);
...
/*
44.Write a query in SQL to display the first and last name, salary, 
and department ID for all those employees who earn more than the average salary and arrange the list in descending order on salary.
*/
...
and department ID for those employees who earn more than the maximum salary of a department which ID is 40.
*/
...
/*
49.Write a query to display the first name and last name of employees along with the name of the 
department they work in. Only include employees whose last name starts with the letter 'S'.
*/
